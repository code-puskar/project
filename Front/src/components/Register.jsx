...
export default function Register({ onClose, onSwitchToLogin }) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-dark-900/90 border border-white/10 p-8 text-left shadow-2xl transition-all sm:w-full sm:max-w-md backdrop-blur-xl">
