        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className={`
                px-6 py-2.5 rounded-xl text-white text-sm font-semibold transition-all active:scale-95 flex items-center gap-2
                ${isSubmitting 
                  ? "bg-brand-600/50 cursor-not-allowed" 
                  : "bg-brand-600 hover:bg-brand-500 shadow-lg shadow-brand-500/25 hover:shadow-brand-500/40"
                }
              `}
            >
              {isSubmitting ? (
